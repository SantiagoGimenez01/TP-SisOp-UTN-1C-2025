...
void* serializar_pcb(t_pcb* pcb, uint32_t* size) {
    ...
    *size = sizeof(uint32_t) * 3 + sizeof(double) * 2 + sizeof(uint32_t); 
    ...
    offset += sizeof(uint32_t);
    memcpy(buffer + offset, &(pcb->tabla_paginas), sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(buffer + offset, &(pcb->estimacion_rafaga), sizeof(double));
    offset += sizeof(double);
    memcpy(buffer + offset, &(pcb->ultima_rafaga_real), sizeof(double));
    offset += sizeof(double);
...
t_pcb* deserializar_pcb(void* buffer) {
    ...
    offset += sizeof(uint32_t);
    memcpy(&(pcb->tabla_paginas), buffer + offset, sizeof(uint32_t));
    offset += sizeof(uint32_t);
    memcpy(&(pcb->estimacion_rafaga), buffer + offset, sizeof(double));
    offset += sizeof(double);
    memcpy(&(pcb->ultima_rafaga_real), buffer + offset, sizeof(double));
    offset += sizeof(double);
