...
char* extraer_fragmento_con_desplazamiento(char* contenido, uint32_t desplazamiento, int tamanio); // Obtiene fragmento desde cierto desplazamiento hasta un puntual tamanio
...
void escribir_fragmento_en_pagina(char* pagina_completa, uint32_t desplazamiento, const char* datos); // Modifica el contenido de una pagina completa en Memoria
